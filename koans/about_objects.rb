...
class AboutObjects < EdgeCase::Koan
  ...
  def test_small_integers_have_fixed_ids
    ...
    # Well, don’t forget that Fixnums are stored in the upper 31 bits, which
    # means a shift left of one. We also use the lowest bit to mark that it is a Fixnum.
    # Thus 0×0101 (5) becomes 0×1011 (11).
    # Source: http://www.oreillynet.com/ruby/blog/2006/02/ruby_values_and_object_ids.html
    n = 5
    assert_equal n*2+1, n.object_id
  end
